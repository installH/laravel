...
@section('info')
    <title>{{$field->art_title}} - {{\Illuminate\Support\Facades\Config::get('web.seo_title')}}</title>
...
<article class="blogs">
  <h1 class="t_nav">
      <span style="float: right"><a href="{{url('/')}}" style="color: black;width: auto;">首页&nbsp;&gt;&nbsp;</a><a href="{{url('cate/'.$field->cate_id)}}" style="color: black;width: auto;">{{$field->cate_name}}&nbsp;&gt;&nbsp;</a><a href="/news/s/" style="color: black;width: auto;">日记</a></span>
